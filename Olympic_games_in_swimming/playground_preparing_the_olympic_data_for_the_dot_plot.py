...
# **************************************************************************************************************
# Function  name: preparing_the_olympic_data_for_the_dot_plot
# input:
# return value: Converting  the values to seconds with two decimal place
# ****************************************************************************************************************
def preparing_the_olympic_data_for_the_dot_plot(df):
   ...
   # ['Team','Stroke','Location', 'Year','Athlete', 'Results (In seconds)']]
    ...
    final_table_fastest_results_6_rows = final_table_fastest_results[final_table_fastest_results['Team'] == 'CAN']
    ...
    final_table_slowest_results_6_rows = final_table_slowest_results[final_table_slowest_results['Team'] == 'CAN']
